...
export function HeroScene() {
  ...
  return (
    <section
      ref={sceneRef}
      data-scene
      className="relative isolate flex min-h-screen items-end justify-center overflow-hidden bg-[#050505]"
    ...
    >
      ...
      <div
        data-light
        aria-hidden="true"
        className="pointer-events-none absolute bottom-[16vh] left-1/2 h-[55vh] w-[80vw] max-w-5xl -translate-x-1/2 scale-75 bg-[radial-gradient(ellipse_at_center,rgba(104,134,218,0.13),transparent_68%)] opacity-0 blur-2xl"
      />

      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center px-5 pb-[12vh]">
        {/* Notebook */}
        <div
          data-notebook
          className="relative z-20 w-[min(78vw,680px)]"
        >
          <div className="rounded-[18px] border border-white/10 bg-[#101114] p-2 shadow-2xl shadow-black">
            <div
              data-screen
              className="relative aspect-16/10 overflow-hidden rounded-[11px] border border-white/5 bg-[#020203]"
            >
              <div
                data-terminal
                className="absolute inset-0 flex flex-col justify-center px-[9%] font-mono text-[clamp(10px,1.4vw,15px)] leading-7 text-white/55 opacity-0"
              >
                ...
                <p className="mt-3">
                  ...
                  <span
                    data-cursor
                    className="ml-1 inline-block h-[1em] w-[0.5em] translate-y-[0.12em] bg-white/70 opacity-0"
                    aria-hidden="true"
                  />
                </p>
              </div>
        ...
        <div
          data-desk
          className="relative z-10 -mt-1 h-14 w-[min(96vw,1050px)] rounded-[50%] border-t border-white/10 bg-linear-to-b from-[#1a1715] to-[#0b0a09] shadow-[0_-12px_40px_rgba(0,0,0,0.8)]"
        >
          {/* Caneca */}
          <div
            aria-hidden="true"
      ...
      <div
        data-scroll-hint
        className="absolute bottom-6 left-1/2 z-20 -translate-x-1/2 translate-y-3 text-center text-[10px] uppercase tracking-[0.32em] text-white/30 opacity-0"
      >
